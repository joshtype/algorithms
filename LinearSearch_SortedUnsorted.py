...
Time Complexity = Linear Time, 0(n), n = {n}\n""")

# Linear Searching unsorted list
...
Time Complexity = Linear Time, 0(n), n = {i+1}\n""")
...
def main():
    ...
    # call search function with best, worst, & random cases
    ...
    # unsort list, call search function with best, worst, & random cases
